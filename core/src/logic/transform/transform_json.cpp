...
template <>
std::shared_ptr<void> Common::ComponentJson<Logic::Transform>::From(const json11::Json &j)
{
...
template <>
json11::Json Common::ComponentJson<Logic::Transform>::To(std::shared_ptr<void> component)
{
