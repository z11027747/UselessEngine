...
template <>
std::shared_ptr<void> Common::ComponentJson<Render::DirectionLight>::From(const json11::Json &j)
{
...
template <>
json11::Json Common::ComponentJson<Render::DirectionLight>::To(std::shared_ptr<void> component)
{
