...
template <>
std::shared_ptr<void> Common::ComponentJson<Render::PointLight>::From(const json11::Json &j)
{
...
template <>
json11::Json Common::ComponentJson<Render::PointLight>::To(std::shared_ptr<void> component)
{
