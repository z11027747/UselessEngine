...
namespace Render {
	...
	void InstanceSystem::Create(Context* context,
		...
		auto instance = std::make_shared<Render::Instance>();
		instance->vkInstance = vkInstance;

		auto& renderGlobalEO = context->renderGlobalEO;
		renderGlobalEO->AddComponent<Render::Instance>(instance);
	}

	void InstanceSystem::Destroy(Context* context) {

		auto& renderGlobalEO = context->renderGlobalEO;
		auto& instance = renderGlobalEO->GetComponent<Render::Instance>();

		vkDestroyInstance(instance->vkInstance, nullptr);

		renderGlobalEO->RemoveComponent<Render::Instance>();
	}
