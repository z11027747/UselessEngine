...
template <>
std::shared_ptr<void> Common::ComponentJson<Render::Mesh>::From(const json11::Json &j)
{
...
template <>
json11::Json Common::ComponentJson<Render::Mesh>::To(std::shared_ptr<void> component)
{
