                                                          ...
                                                          std::shared_ptr<GraphicsPipeline> graphicsPipeline)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<GraphicsPipeline>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Simple, MaterialPBRSimplePipelineLogic::SetVertexAttrDescriptions},
                {Define::Pipeline::PBR_Texture, MaterialPBRTexturePipelineLogic::SetVertexAttrDescriptions},
                                                           ...
                                                           std::shared_ptr<GraphicsPipeline> graphicsPipeline)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<GraphicsPipeline>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Simple, MaterialPBRSimplePipelineLogic::SetRasterizationCreateInfo},
                {Define::Pipeline::PBR_Texture, MaterialPBRTexturePipelineLogic::SetRasterizationCreateInfo},
                                                         ...
                                                         std::shared_ptr<GraphicsPipeline> graphicsPipeline)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<GraphicsPipeline>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Texture, MaterialDeferredLightModelPipelineLogic::SetMultisampleCreateInfo},
            };
                                                          ...
                                                          std::shared_ptr<GraphicsPipeline> graphicsPipeline)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<GraphicsPipeline>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Simple, MaterialPBRSimplePipelineLogic::SetDepthStencilCreateInfo},
                {Define::Pipeline::PBR_Texture, MaterialPBRTexturePipelineLogic::SetDepthStencilCreateInfo},
