                                                  ...
                                                  std::shared_ptr<GraphicsPipeline> graphicsPipeline)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<GraphicsPipeline>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Simple, MaterialPBRSimpleDescriptorLogic::CreateSetLayout},
                {Define::Pipeline::PBR_Texture, MaterialPBRTextureDescriptorLogic::CreateSetLayout},
                ...
                {Define::Pipeline::PostProcess_SSAO, MaterialPostProcessSSAODescriptorLogic::CreateSetLayout},
                                                    ...
                                                    std::shared_ptr<MaterialData> data)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<MaterialData>)>>
            funcMap{
                ...
                {Define::Pipeline::PBR_Simple, MaterialPBRSimpleDescriptorLogic::AllocateAndUpdate},
                {Define::Pipeline::PBR_Texture, MaterialPBRTextureDescriptorLogic::AllocateAndUpdate},
                ...
                {Define::Pipeline::PostProcess_SSAO, MaterialPostProcessSSAODescriptorLogic::AllocateAndUpdate},
                                          ...
                                          std::shared_ptr<MaterialData> data)
    {
        static std::unordered_map<std::string, std::function<void(Context *, std::shared_ptr<MaterialData>)>>
            funcMap{
                ...
                {Define::Pipeline::PostProcess_SSAO, MaterialPostProcessSSAODescriptorLogic::Destroy},
