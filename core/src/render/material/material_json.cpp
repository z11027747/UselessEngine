...
template <>
std::shared_ptr<void> Common::ComponentJson<Render::Material>::From(const json11::Json &j)
{
...
template <>
json11::Json Common::ComponentJson<Render::Material>::To(std::shared_ptr<void> component)
{
