...
void RenderSystem::CreateGraphicsPipeline(Context* context) {
	...
	MakeShaderModuleCreateInfos(shaderModules, shaderStageCreateInfos);
	...
	MakeViewportCreateInfo(viewport, scissor, viewportStateCreateInfo, swapChainExtent);
...
void RenderSystem::MakeInputAssemblyCreateInfo(
	VkPipelineInputAssemblyStateCreateInfo& inputAssemblyStateCreateInfo)
{
...
//视口+裁剪
void RenderSystem::MakeViewportCreateInfo(
	VkViewport& viewport, VkRect2D& scissor, VkPipelineViewportStateCreateInfo& viewportStateCreateInfo,
...
void RenderSystem::MakeRasterizationCreateInfo(
	VkPipelineRasterizationStateCreateInfo& rasterizationStateCreateInfo)
{
	...
	rasterizationStateCreateInfo.cullMode = VK_CULL_MODE_BACK_BIT; //剔除
...
//多重采样
void RenderSystem::MakeMultisampleCreateInfo(
	VkPipelineMultisampleStateCreateInfo& multisampleStateCreateInfo)
{
...
//	混合旧值和新值产生最终的颜色
//	使用位运算组合旧值和新值
void RenderSystem::MakeColorBlendCreateInfo(
	VkPipelineColorBlendAttachmentState& colorBlendAttachmentState,
	VkPipelineColorBlendStateCreateInfo& colorBlendingStateCreateInfo)
{
