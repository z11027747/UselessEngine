...
layout (input_attachment_index = 1, set = 0, binding = 2) uniform subpassInput gaussBlurAttachment;
layout (input_attachment_index = 2, set = 0, binding = 3) uniform subpassInput bloomAttachment;
